...
func (m *GoCode) CloneVT() *GoCode {
	...
	r := &GoCode{
		...
		EmitEmptySlices:           m.EmitEmptySlices,
		EmitExportedQueries:       m.EmitExportedQueries,
		...
		SqlDriver:                 m.SqlDriver,
		OutputDbFileName:          m.OutputDbFileName,
		OutputModelsFileName:      m.OutputModelsFileName,
		OutputQuerierFileName:     m.OutputQuerierFileName,
		OutputCopyfromFileName:    m.OutputCopyfromFileName,
		OutputFilesSuffix:         m.OutputFilesSuffix,
		EmitEnumValidMethod:       m.EmitEnumValidMethod,
	...
	if rhs := m.InflectionExcludeTableNames; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.InflectionExcludeTableNames = tmpContainer
	}
	if rhs := m.QueryParameterLimit; rhs != nil {
		tmpVal := *rhs
...
func (this *GoCode) EqualVT(that *GoCode) bool {
	...
	for i, vx := range this.InflectionExcludeTableNames {
		vy := that.InflectionExcludeTableNames[i]
		if vx != vy {
			return false
		}
	}
...
func (m *GoCode) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.OutputCopyfromFileName) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.OutputCopyfromFileName)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xe2
...
func (m *Settings) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.Json != nil {
		size, err := m.Json.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.Go != nil {
		size, err := m.Go.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *GoCode) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 28:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OutputCopyfromFileName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
